...
np.savetxt('206Ref-Comp207-ScatTracking.txt',x004,delimiter=',', fmt='%.9f')
...
np.savetxt('TopScat-206-RefXYCoordinates.txt',RefCoord,delimiter=',', fmt='%.9f')

x005 = np.vstack((x02,x04))
x006 = np.transpose(x005)
x007 = x006.astype(np.float)
np.savetxt('206Ref-Comp207-XYCoord.txt',x007,delimiter=',', fmt='%.9f')