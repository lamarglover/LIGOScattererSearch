...
%  non
%% ---------User Input---------------------
blah1 = size(Scatterers0206)
blah2 = blah1(1)
MdataSize = blah2; % Size of nxn data matrix
% parameters are: [Amplitude, x0, sigmax, y0, sigmay, angle(in rad)]
x0 = [5000,2400,50,2400,50,0]; %Inital guess parameters
x = [2,2.2,7,3.4,4.5,0]; %centroid parameters
