...
lines = open( '258-ShrCoeff-Scat.txt', "r" ).readlines()[::2] #reference ALS content here
...
np.savetxt('258Ref-Comp258-ScatTracking.txt',TopZSortRef,delimiter=',', fmt='%.9f')
...
np.savetxt('261Ref-Comp262-ScatTracking.txt',x004,delimiter=',', fmt='%.9f')
...
np.savetxt('TopScat-261-RefXYCoordinates.txt',RefCoord,delimiter=',', fmt='%.9f')

x005 = np.vstack((x02,x04))
x006 = np.transpose(x005)
x007 = x006.astype(np.float)
np.savetxt('261Ref-Comp262-XYCoord.txt',x007,delimiter=',', fmt='%.9f')